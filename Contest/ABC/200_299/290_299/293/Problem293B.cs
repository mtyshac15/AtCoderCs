...
namespace AtCoderCs.Contest.ABC293;
...
public class ProblemB
{
    ...
    public void Solve()
    {
        ...
        var reminder = Enumerable.Range(1, N).Except(called).ToArray();
        var ansBuilder = new StringBuilder();
        ansBuilder.AppendLine($"{reminder.Length}");
        ansBuilder.AppendLine($"{string.Join(" ", reminder)}");
