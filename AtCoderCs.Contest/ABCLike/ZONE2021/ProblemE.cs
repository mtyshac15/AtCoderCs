...
namespace AtCoderCs.Contest.ABCLike.ZONE2021.ProblemE;
...
public class ProblemE
{
    ...
    public void Solve()
    {
        ...
        var A = _reader.IntGrid(R, C);
        var B = _reader.IntGrid(R - 1, C);
...
class ProgramE
{
    public static void Main(string[] args)
    {
        ...
        var problem = new ProblemE(Console.In, Console.Out);
        problem.Solve();
        Console.Out.Flush();
    }
}
