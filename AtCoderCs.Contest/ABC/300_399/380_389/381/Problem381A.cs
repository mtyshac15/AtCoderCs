...
namespace AtCoderCs.Contest.ABC381.ProblemA;
...
public class ProblemA
{
    ...
    public void Solve()
    {
        ...
        var first = array[0].Sum(x => int.Parse(x.ToString()));
        var second = array[1].Sum(x => int.Parse(x.ToString()));

        var ans = first == array[0].Length && second == 2 * array[1].Length;
