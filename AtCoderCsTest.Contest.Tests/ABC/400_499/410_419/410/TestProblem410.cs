using AtCoderCs.Contest.ABC410.ProblemA;
using AtCoderCs.Contest.ABC410.ProblemB;
using AtCoderCs.Contest.ABC410.ProblemC;
using AtCoderCs.Contest.ABC410.ProblemD;
using AtCoderCs.Contest.ABC410.ProblemE;
using AtCoderCs.Contest.ABC410.ProblemF;
using AtCoderCs.Contest.ABC410.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC410;

[Contest($"ABC", $"410")]
[Sample($"ABC", $"400_499", "410_419", $"410")]
