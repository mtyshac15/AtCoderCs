using AtCoderCs.Contest.ABC402.ProblemA;
using AtCoderCs.Contest.ABC402.ProblemB;
using AtCoderCs.Contest.ABC402.ProblemC;
using AtCoderCs.Contest.ABC402.ProblemD;
using AtCoderCs.Contest.ABC402.ProblemE;
using AtCoderCs.Contest.ABC402.ProblemF;
using AtCoderCs.Contest.ABC402.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC402;

[Contest($"ABC", $"402")]
[Sample($"ABC", $"400_499", "400_409", $"402")]
