using AtCoderCs.Contest.ABC375.ProblemA;
using AtCoderCs.Contest.ABC375.ProblemB;
using AtCoderCs.Contest.ABC375.ProblemC;
using AtCoderCs.Contest.ABC375.ProblemD;
using AtCoderCs.Contest.ABC375.ProblemE;
using AtCoderCs.Contest.ABC375.ProblemF;
using AtCoderCs.Contest.ABC375.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC375;

[Contest($"ABC", $"375")]
[Sample($"ABC", $"300_399", "370_379", $"375")]
...
#if DEBUG
    [Theory(DisplayName = $"ABC 375")]
    [Trait("Contest", "ABC")]
    [InlineData($"A", typeof(ProblemA), nameof(ProblemA.Solve))]
    [InlineData($"B", typeof(ProblemB), nameof(ProblemB.Solve), 10, -6)]
