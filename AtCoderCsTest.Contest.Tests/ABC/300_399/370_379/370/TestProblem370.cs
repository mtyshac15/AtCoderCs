using AtCoderCs.Contest.ABC370.ProblemA;
using AtCoderCs.Contest.ABC370.ProblemB;
using AtCoderCs.Contest.ABC370.ProblemC;
using AtCoderCs.Contest.ABC370.ProblemD;
using AtCoderCs.Contest.ABC370.ProblemE;
using AtCoderCs.Contest.ABC370.ProblemF;
using AtCoderCs.Contest.ABC370.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC370;

[Contest($"ABC", $"370")]
[Sample($"ABC", $"300_399", "370_379", $"370")]
