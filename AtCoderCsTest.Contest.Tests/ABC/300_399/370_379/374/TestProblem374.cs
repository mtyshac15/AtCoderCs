using AtCoderCs.Contest.ABC374.ProblemA;
using AtCoderCs.Contest.ABC374.ProblemB;
using AtCoderCs.Contest.ABC374.ProblemC;
using AtCoderCs.Contest.ABC374.ProblemD;
using AtCoderCs.Contest.ABC374.ProblemE;
using AtCoderCs.Contest.ABC374.ProblemF;
using AtCoderCs.Contest.ABC374.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC374;

[Contest($"ABC", $"374")]
[Sample($"ABC", $"300_399", "370_379", $"374")]
