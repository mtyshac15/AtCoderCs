using AtCoderCs.Contest.ABC372.ProblemA;
using AtCoderCs.Contest.ABC372.ProblemB;
using AtCoderCs.Contest.ABC372.ProblemC;
using AtCoderCs.Contest.ABC372.ProblemD;
using AtCoderCs.Contest.ABC372.ProblemE;
using AtCoderCs.Contest.ABC372.ProblemF;
using AtCoderCs.Contest.ABC372.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC372;

[Contest($"ABC", $"372")]
[Sample($"ABC", $"300_399", "370_379", $"372")]
