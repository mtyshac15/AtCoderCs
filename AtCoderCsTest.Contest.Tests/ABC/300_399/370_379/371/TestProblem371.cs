using AtCoderCs.Contest.ABC371.ProblemA;
using AtCoderCs.Contest.ABC371.ProblemB;
using AtCoderCs.Contest.ABC371.ProblemC;
using AtCoderCs.Contest.ABC371.ProblemD;
using AtCoderCs.Contest.ABC371.ProblemE;
using AtCoderCs.Contest.ABC371.ProblemF;
using AtCoderCs.Contest.ABC371.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC371;

[Contest($"ABC", $"371")]
[Sample($"ABC", $"300_399", "370_379", $"371")]
