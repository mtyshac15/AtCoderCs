using AtCoderCs.Contest.ABC373.ProblemA;
using AtCoderCs.Contest.ABC373.ProblemB;
using AtCoderCs.Contest.ABC373.ProblemC;
using AtCoderCs.Contest.ABC373.ProblemD;
using AtCoderCs.Contest.ABC373.ProblemE;
using AtCoderCs.Contest.ABC373.ProblemF;
using AtCoderCs.Contest.ABC373.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC373;

[Contest($"ABC", $"373")]
[Sample($"ABC", $"300_399", "370_379", $"373")]
