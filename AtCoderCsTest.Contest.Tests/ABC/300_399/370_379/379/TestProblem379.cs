using AtCoderCs.Contest.ABC379.ProblemA;
using AtCoderCs.Contest.ABC379.ProblemB;
using AtCoderCs.Contest.ABC379.ProblemC;
using AtCoderCs.Contest.ABC379.ProblemD;
using AtCoderCs.Contest.ABC379.ProblemE;
using AtCoderCs.Contest.ABC379.ProblemF;
using AtCoderCs.Contest.ABC379.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC379;

[Contest($"ABC", $"379")]
[Sample($"ABC", $"300_399", "370_379", $"379")]
