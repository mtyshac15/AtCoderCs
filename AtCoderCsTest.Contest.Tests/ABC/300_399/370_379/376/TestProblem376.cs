using AtCoderCs.Contest.ABC376.ProblemA;
using AtCoderCs.Contest.ABC376.ProblemB;
using AtCoderCs.Contest.ABC376.ProblemC;
using AtCoderCs.Contest.ABC376.ProblemD;
using AtCoderCs.Contest.ABC376.ProblemE;
using AtCoderCs.Contest.ABC376.ProblemF;
using AtCoderCs.Contest.ABC376.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC376;

[Contest($"ABC", $"376")]
[Sample($"ABC", $"300_399", "370_379", $"376")]
