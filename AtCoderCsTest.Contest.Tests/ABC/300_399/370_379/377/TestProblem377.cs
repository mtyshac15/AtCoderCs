using AtCoderCs.Contest.ABC377.ProblemA;
using AtCoderCs.Contest.ABC377.ProblemB;
using AtCoderCs.Contest.ABC377.ProblemC;
using AtCoderCs.Contest.ABC377.ProblemD;
using AtCoderCs.Contest.ABC377.ProblemE;
using AtCoderCs.Contest.ABC377.ProblemF;
using AtCoderCs.Contest.ABC377.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC377;

[Contest($"ABC", $"377")]
[Sample($"ABC", $"300_399", "370_379", $"377")]
