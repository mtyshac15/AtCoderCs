using AtCoderCs.Contest.ABC388.ProblemA;
using AtCoderCs.Contest.ABC388.ProblemB;
using AtCoderCs.Contest.ABC388.ProblemC;
using AtCoderCs.Contest.ABC388.ProblemD;
using AtCoderCs.Contest.ABC388.ProblemE;
using AtCoderCs.Contest.ABC388.ProblemF;
using AtCoderCs.Contest.ABC388.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC388;

[Contest($"ABC", $"388")]
[Sample($"ABC", $"300_399", "380_389", $"388")]
