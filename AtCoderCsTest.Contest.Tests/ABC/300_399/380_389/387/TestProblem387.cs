using AtCoderCs.Contest.ABC387.ProblemA;
using AtCoderCs.Contest.ABC387.ProblemB;
using AtCoderCs.Contest.ABC387.ProblemC;
using AtCoderCs.Contest.ABC387.ProblemD;
using AtCoderCs.Contest.ABC387.ProblemE;
using AtCoderCs.Contest.ABC387.ProblemF;
using AtCoderCs.Contest.ABC387.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC387;

[Contest($"ABC", $"387")]
[Sample($"ABC", $"300_399", "380_389", $"387")]
