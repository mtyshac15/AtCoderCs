using AtCoderCs.Contest.ABC385.ProblemA;
using AtCoderCs.Contest.ABC385.ProblemB;
using AtCoderCs.Contest.ABC385.ProblemC;
using AtCoderCs.Contest.ABC385.ProblemD;
using AtCoderCs.Contest.ABC385.ProblemE;
using AtCoderCs.Contest.ABC385.ProblemF;
using AtCoderCs.Contest.ABC385.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC385;

[Contest($"ABC", $"385")]
[Sample($"ABC", $"300_399", "380_389", $"385")]
