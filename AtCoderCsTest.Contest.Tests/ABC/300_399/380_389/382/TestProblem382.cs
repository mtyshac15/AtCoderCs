using AtCoderCs.Contest.ABC382.ProblemA;
using AtCoderCs.Contest.ABC382.ProblemB;
using AtCoderCs.Contest.ABC382.ProblemC;
using AtCoderCs.Contest.ABC382.ProblemD;
using AtCoderCs.Contest.ABC382.ProblemE;
using AtCoderCs.Contest.ABC382.ProblemF;
using AtCoderCs.Contest.ABC382.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC382;

[Contest($"ABC", $"382")]
[Sample($"ABC", $"300_399", "380_389", $"382")]
