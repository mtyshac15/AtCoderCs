using AtCoderCs.Contest.ABC389.ProblemA;
using AtCoderCs.Contest.ABC389.ProblemB;
using AtCoderCs.Contest.ABC389.ProblemC;
using AtCoderCs.Contest.ABC389.ProblemD;
using AtCoderCs.Contest.ABC389.ProblemE;
using AtCoderCs.Contest.ABC389.ProblemF;
using AtCoderCs.Contest.ABC389.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC389;

[Contest($"ABC", $"389")]
[Sample($"ABC", $"300_399", "380_389", $"389")]
