using AtCoderCs.Contest.ABC384.ProblemA;
using AtCoderCs.Contest.ABC384.ProblemB;
using AtCoderCs.Contest.ABC384.ProblemC;
using AtCoderCs.Contest.ABC384.ProblemD;
using AtCoderCs.Contest.ABC384.ProblemE;
using AtCoderCs.Contest.ABC384.ProblemF;
using AtCoderCs.Contest.ABC384.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC384;

[Contest($"ABC", $"384")]
[Sample($"ABC", $"300_399", "380_389", $"384")]
