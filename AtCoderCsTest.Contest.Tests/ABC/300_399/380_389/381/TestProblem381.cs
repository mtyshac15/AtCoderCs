using AtCoderCs.Contest.ABC381.ProblemA;
using AtCoderCs.Contest.ABC381.ProblemB;
using AtCoderCs.Contest.ABC381.ProblemC;
using AtCoderCs.Contest.ABC381.ProblemD;
using AtCoderCs.Contest.ABC381.ProblemE;
using AtCoderCs.Contest.ABC381.ProblemF;
using AtCoderCs.Contest.ABC381.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC381;

[Contest($"ABC", $"381")]
[Sample($"ABC", $"300_399", "380_389", $"381")]
