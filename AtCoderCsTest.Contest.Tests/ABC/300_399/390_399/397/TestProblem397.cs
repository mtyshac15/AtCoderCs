using AtCoderCs.Contest.ABC397.ProblemA;
using AtCoderCs.Contest.ABC397.ProblemB;
using AtCoderCs.Contest.ABC397.ProblemC;
using AtCoderCs.Contest.ABC397.ProblemD;
using AtCoderCs.Contest.ABC397.ProblemE;
using AtCoderCs.Contest.ABC397.ProblemF;
using AtCoderCs.Contest.ABC397.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC397;

[Contest($"ABC", $"397")]
[Sample($"ABC", $"300_399", "390_399", $"397")]
