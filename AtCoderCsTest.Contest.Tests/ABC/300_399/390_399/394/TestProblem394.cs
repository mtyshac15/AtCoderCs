using AtCoderCs.Contest.ABC394.ProblemA;
using AtCoderCs.Contest.ABC394.ProblemB;
using AtCoderCs.Contest.ABC394.ProblemC;
using AtCoderCs.Contest.ABC394.ProblemD;
using AtCoderCs.Contest.ABC394.ProblemE;
using AtCoderCs.Contest.ABC394.ProblemF;
using AtCoderCs.Contest.ABC394.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC394;

[Contest($"ABC", $"394")]
[Sample($"ABC", $"300_399", "390_399", $"394")]
