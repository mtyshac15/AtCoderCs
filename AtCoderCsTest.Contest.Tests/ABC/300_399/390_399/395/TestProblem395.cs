using AtCoderCs.Contest.ABC395.ProblemA;
using AtCoderCs.Contest.ABC395.ProblemB;
using AtCoderCs.Contest.ABC395.ProblemC;
using AtCoderCs.Contest.ABC395.ProblemD;
using AtCoderCs.Contest.ABC395.ProblemE;
using AtCoderCs.Contest.ABC395.ProblemF;
using AtCoderCs.Contest.ABC395.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC395;

[Contest($"ABC", $"395")]
[Sample($"ABC", $"300_399", "390_399", $"395")]
