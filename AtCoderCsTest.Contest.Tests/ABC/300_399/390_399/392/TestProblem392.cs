using AtCoderCs.Contest.ABC392.ProblemA;
using AtCoderCs.Contest.ABC392.ProblemB;
using AtCoderCs.Contest.ABC392.ProblemC;
using AtCoderCs.Contest.ABC392.ProblemD;
using AtCoderCs.Contest.ABC392.ProblemE;
using AtCoderCs.Contest.ABC392.ProblemF;
using AtCoderCs.Contest.ABC392.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC392;

[Contest($"ABC", $"392")]
[Sample($"ABC", $"300_399", "390_399", $"392")]
