using AtCoderCs.Contest.ABC393.ProblemA;
using AtCoderCs.Contest.ABC393.ProblemB;
using AtCoderCs.Contest.ABC393.ProblemC;
using AtCoderCs.Contest.ABC393.ProblemD;
using AtCoderCs.Contest.ABC393.ProblemE;
using AtCoderCs.Contest.ABC393.ProblemF;
using AtCoderCs.Contest.ABC393.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC393;

[Contest($"ABC", $"393")]
[Sample($"ABC", $"300_399", "390_399", $"393")]
