using AtCoderCs.Contest.ABC391.ProblemA;
using AtCoderCs.Contest.ABC391.ProblemB;
using AtCoderCs.Contest.ABC391.ProblemC;
using AtCoderCs.Contest.ABC391.ProblemD;
using AtCoderCs.Contest.ABC391.ProblemE;
using AtCoderCs.Contest.ABC391.ProblemF;
using AtCoderCs.Contest.ABC391.ProblemG;
using AtCoderCsTest.Contents.Services;
using Microsoft.Extensions.Logging;
using System.Reflection;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC391;

[Contest($"ABC", $"391")]
[Sample($"ABC", $"300_399", "390_399", $"391")]
