...
namespace AtCoderCs.Training.Tests.B61;

[Collection(nameof(TrainingTestCollection))]
[Contest($"IroncladRule", $"61")]
[Sample($"IroncladRule", $"ProblemB", $"61")]
...
#if DEBUG
  [Theory(DisplayName = $"IroncladRule 61")]
  [InlineData($"", typeof(ProblemB), nameof(ProblemB.Solve))]
