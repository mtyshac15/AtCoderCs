...
namespace AtCoderCs.Training.Tests.A20;

[Collection(nameof(TrainingTestCollection))]
[Contest($"IroncladRule", $"20")]
[Sample($"IroncladRule", $"ProblemA", $"20_29", $"20")]
...
#if DEBUG
  [Theory(DisplayName = $"IroncladRule 20")]
