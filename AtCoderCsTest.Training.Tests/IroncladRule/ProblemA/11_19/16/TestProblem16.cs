...
namespace AtCoderCs.Training.Tests.A16;

[Collection(nameof(TrainingTestCollection))]
[Contest($"IroncladRule", $"16")]
[Sample($"IroncladRule", $"ProblemA", $"11_19", $"16")]
...
#if DEBUG
  [Theory(DisplayName = $"IroncladRule 16")]
