...
using AtCoderCs.Contest.ABC290;
using AtCoderCs.Contest.Tests;
using System.Reflection;
using Xunit;

namespace AtCoderCs.Contest.Tests.ABC290;

public class Problem
{
    private static readonly string _contestSection = $"ABC";
    private static readonly string _problemFolder = Path.Combine($"200_299", "290_299");
    private static readonly string _problemNumber = $"290";
    ...
    public void SolveB()
    {
        ...
        TestTools.Solve(sample, typeof(ProblemB), nameof(ProblemB.Solve), 0.00001);
    }
