...
using AtCoderCs.Contest.ABC246;
...
namespace AtCoderCs.Contest.Tests.ABC246;
...
public class Problem : IClassFixture<TestFixture>
{
    ...
    private static readonly string _problemFolder = Path.Combine($"200_299", "240_249");
