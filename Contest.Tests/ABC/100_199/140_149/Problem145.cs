...
using AtCoderCs.Contest.ABC145;
using AtCoderCs.Contest.Tests;
using System.Reflection;
using Xunit;

namespace AtCoderCs.Contest.Tests.ABC145;

public class Problem
{
    private static readonly string _contestSection = $"ABC";
    private static readonly string _problemFolder = Path.Combine($"100_199", "140_149");
    private static readonly string _problemNumber = $"145";
    ...
    public void SolveC()
    {
        ...
        TestTools.Judge(expectedDic, actualDic, 0.0000001);
    }
