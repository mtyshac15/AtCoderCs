using AtCoderCs.Contest.ABC188;
...
namespace AtCoderCs.Contest.Tests.ABC188;
...
public class Problem : IClassFixture<TestFixture>
{
    ...
    private static readonly string _problemFolder = Path.Combine($"100_199", "100_189");
