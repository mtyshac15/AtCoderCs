using AtCoderCs.Contest.ABC022;
using Contest.Tests.Services;
using Microsoft.Extensions.Logging;
using Xunit;
using Xunit.Abstractions;

namespace AtCoderCs.Contest.Tests.ABC022;
...
public class Problem : IClassFixture<TestFixture>
{
    ...
    private static readonly string _problemFolder = Path.Combine($"000_099", "020_029");
